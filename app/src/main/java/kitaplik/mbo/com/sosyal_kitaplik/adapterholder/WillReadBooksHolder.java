...
public class WillReadBooksHolder extends RecyclerView.ViewHolder {
    ...
    public WillReadBooksHolder(View itemView) {
        super(itemView);
        ...
        btndelete = (Button) itemView.findViewById(R.id.btndeletewillread);
