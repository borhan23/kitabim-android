...
public class ReadedBooksHolder extends RecyclerView.ViewHolder {
    ...
    public ReadedBooksHolder(View itemView) {
        super(itemView);
        ...
        btndelete = (Button) itemView.findViewById(R.id.btndeletereaded);
