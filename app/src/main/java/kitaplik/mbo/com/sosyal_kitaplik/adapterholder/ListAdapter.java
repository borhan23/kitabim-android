...
public class ListAdapter extends RecyclerView.Adapter<MyViewHolder> {
    ...
    private String TAG="profilkarti";
    ...
    public ListAdapter(Context c, ArrayList<Citations> citations){
        this.c = c;
...
//Profil Kartında okunan kitabın gösterilmesi
    ...
    private void kitapVeriAl(String book_id, final MyViewHolder holder) {
        book = new Book();
        myRef = FirebaseDatabase.getInstance().getReference();
        myRef.child("Books").child(book_id).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                book=dataSnapshot.getValue(Book.class);
                holder.flowcontentbook.setText("Kitap: "+book.getBook_name()+", "+book.getBook_author());
    ...
    private void kullaniciBilgisi(final MyViewHolder holder, String user_id) {
